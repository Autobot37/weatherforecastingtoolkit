...
CHECKPOINT_DIR="/home/vatsal/NWM/weatherforecasting/experiments/pretrained_ae_convattn_ae_sevir/outputs/wandb/latest-run/files/checkpoints"
TRAIN_SCRIPT="experiments.pretrained_ae_convattn_ae_sevir.train"
PYTHON_CMD="python -m"
SUCCESS_MARKER="done"    
