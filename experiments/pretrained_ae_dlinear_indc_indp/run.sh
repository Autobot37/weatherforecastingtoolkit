...
EXPERIMENT_DIR="/home/vatsal/NWM/weatherforecasting/experiments/pretrained_ae_dlinear_indc_indp"
OUTPUTS_DIR="${EXPERIMENT_DIR}/outputs/wandb"
TRAIN_SCRIPT="experiments.pretrained_ae_dlinear_indc_indp.train"
PYTHON_CMD="python -m"
SUCCESS_MARKER="done"
