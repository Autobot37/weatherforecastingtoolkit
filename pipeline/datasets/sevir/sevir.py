...
class SEVIRLightningDataModule(LightningDataModule):
    ...
    def plot_sample(
        ...
        #input -> data: {"data" : 
        #               {"name1" : (b,t,h,w)[0,1], "name2" : (b,t,h,w)[0,1], ...}, 
        #                "label"  : str,
        ...
        for i, key in enumerate(keys):
            data = sample[key][0] * 255.0
            cmap, norm, vmin, vmax = cmaps[key]
            idxs = t_indices[key]
            ...
            for j in range(max_cols):
                ...
                if j < len(idxs):
                    t = idxs[j]
                    im = ax.imshow(data[t], aspect='auto', cmap=cmap, norm=norm, vmin=vmin, vmax=vmax)
                    if i == 0:
